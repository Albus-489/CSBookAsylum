...
{
    public partial class finallybookseeder : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "created", "descriptionInfo", "genre", "name", "rating" },
                values: new object[,]
                {
                    { 1, null, "No info 1", "Preview genre 1", "Preview book 1", 2 },
                    { 2, null, "No info 2", "Preview genre 2", "Preview book 2", 90 }
                });
